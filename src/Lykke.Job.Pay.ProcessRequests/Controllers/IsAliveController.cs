...
namespace Lykke.Job.Pay.ProcessRequests.Controllers
{
    ...
    public class IsAliveController : Controller
    {
        ...
        public IActionResult Get()
        {
            ...
            return Ok(new IsAliveResponse
            {
                ...
                LastBbHandlerStartedMoment = _healthService.LastPrServiceStartedMoment,
                LastBbHandlerDuration = _healthService.MaxHealthyPrServiceDuration,
                MaxHealthyFooDuration = _healthService.MaxHealthyPrServiceDuration
            });
        }
    }
}